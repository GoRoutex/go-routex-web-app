...
export function MerchantSidebar({
  ...
  return (
    <aside
      className={`flex flex-col h-screen py-6 shrink-0 overflow-y-auto border-r transition-all duration-300 ${
                        ...
                        {item.subItems.map((sub) => {
                          ...
                          return (
                            <NavLink
                              key={sub.label}
                              to={sub.to}
                              className={`flex items-center gap-2 py-1.5 text-[12px] font-bold transition-colors ${
                                isSubActive
                                  ? "text-slate-900"
