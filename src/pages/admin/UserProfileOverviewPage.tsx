...
const staffData = [
  { id: '#ST9801', name: 'Natali Craig', avatar: 'https://i.pravatar.cc/150?u=1', route: 'Route A1 (North)', employeeId: 'DR-10492', date: 'Just now', status: 'Active', statusColor: 'text-blue-500', bg: 'bg-blue-500' },
  { id: '#ST9802', name: 'Kate Morrison', avatar: 'https://i.pravatar.cc/150?u=2', route: 'Airport Express', employeeId: 'DR-11920', date: 'A minute ago', status: 'Completed', statusColor: 'text-green-500', bg: 'bg-green-500' },
  { id: '#ST9803', name: 'Drew Cano', avatar: 'https://i.pravatar.cc/150?u=3', route: 'Downtown B5', employeeId: 'ST-09218', date: '1 hour ago', status: 'Pending', statusColor: 'text-sky-400', bg: 'bg-sky-400' },
  { id: '#ST9804', name: 'Orlando Diggs', avatar: 'https://i.pravatar.cc/150?u=4', route: 'Cross-Town 10', employeeId: 'DR-12831', date: 'Yesterday', status: 'Approved', statusColor: 'text-orange-400', bg: 'bg-orange-400' },
  { id: '#ST9805', name: 'Andi Lane', avatar: 'https://i.pravatar.cc/150?u=5', route: 'Coastal Line', employeeId: 'ST-10029', date: 'Feb 2, 2026', status: 'Rejected', statusColor: 'text-gray-400', bg: 'bg-gray-400' },
  { id: '#ST9801', name: 'Natali Craig', avatar: 'https://i.pravatar.cc/150?u=1', route: 'Route A1 (North)', employeeId: 'DR-10492', date: 'Just now', status: 'Active', statusColor: 'text-blue-500', bg: 'bg-blue-500' },
  { id: '#ST9802', name: 'Kate Morrison', avatar: 'https://i.pravatar.cc/150?u=2', route: 'Airport Express', employeeId: 'DR-11920', date: 'A minute ago', status: 'Completed', statusColor: 'text-green-500', bg: 'bg-green-500' },
  { id: '#ST9803', name: 'Drew Cano', avatar: 'https://i.pravatar.cc/150?u=3', route: 'Downtown B5', employeeId: 'ST-09218', date: '1 hour ago', status: 'Pending', statusColor: 'text-sky-400', bg: 'bg-sky-400' },
  { id: '#ST9804', name: 'Orlando Diggs', avatar: 'https://i.pravatar.cc/150?u=4', route: 'Cross-Town 10', employeeId: 'DR-12831', date: 'Yesterday', status: 'Approved', statusColor: 'text-orange-400', bg: 'bg-orange-400' },
...
export function UserProfileOverviewPage() {
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <h2 className="text-[14px] font-semibold text-gray-900 mb-6">Staff Performance Log</h2>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="text-[12px] text-gray-400 font-medium border-b border-gray-50">
                ...
                <th className="px-4 py-4 font-medium">Record ID</th>
                <th className="px-4 py-4 font-medium">Staff Member</th>
