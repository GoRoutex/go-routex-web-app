...
export function DashboardFinancePage() {
  // Let's reuse DashboardFinancePage for Revenue overview but renamed internally or just kept as a filename for now.
  // Actually, I am creating this as 'DashboardFinancePage' to replace the existing one and serve as Revenue Report.
  
  const revenueTrendData = [
    { name: 'Mon', revenue: 14500, target: 12000 },
    { name: 'Tue', revenue: 16200, target: 12000 },
    { name: 'Wed', revenue: 15800, target: 12000 },
    { name: 'Thu', revenue: 17100, target: 12000 },
    { name: 'Fri', revenue: 19500, target: 15000 },
    { name: 'Sat', revenue: 24600, target: 20000 },
    { name: 'Sun', revenue: 26800, target: 20000 },
  ]

  const revenueByRoute = [
    { name: 'Downtown Express', value: 45000 },
    { name: 'Airport Shuttle', value: 38000 },
    { name: 'Coastal Line', value: 25000 },
    { name: 'City Loop', value: 18000 },
  ]

  const kpis = [
    { label: 'Weekly Revenue', value: '$134.5K', delta: '+12.4%', positive: true, bg: 'bg-[#E5ECF6]' },
    { label: 'Avg. Daily Revenue', value: '$19.2K', delta: '+8.1%', positive: true, bg: 'bg-[#E3F5FF]' },
    { label: 'Revenue per Km', value: '$3.45', delta: '-1.2%', positive: false, bg: 'bg-red-50' },
  ]
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-[14px] font-semibold text-gray-900 uppercase tracking-wider">Revenue Analysis</h2>
          <span className="text-[12px] text-gray-400 font-medium">Income tracking & predictions</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4 text-[11px]">
               <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-gray-900 font-medium">Actual Revenue</span>
               </div>
               <div className="flex items-center gap-1.5">
        ...
        <div className="bg-[#F7F9FB] rounded-3xl p-8">
          <h3 className="text-[14px] font-semibold mb-8">Revenue by Route</h3>
          <div className="h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
