    ...
    <div className="flex flex-col gap-1.5 flex-1 text-left">
        ...
        <div
            className="flex items-center gap-3 px-4 py-4 bg-slate-50 border border-slate-100
                      ...
                      rounded-2xl transition-all group cursor-text relative"
        >
...
export default function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-brand-primary/10">
            ...
            <section className="relative pt-12 pb-24 px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col items-center text-center mb-16 px-4">
                        ...
                        <div className="bg-white border border-slate-100 rounded-[2.5rem] p-4 lg:p-6 shadow-2xl shadow-slate-200/60 relative z-20 mt-12">
                            <div className="flex flex-col lg:flex-row gap-4">
                                {/* Search Inputs Grid */}
                                <div className={`grid grid-cols-1 md:grid-cols-2 ${tripType === "round-trip" ? "lg:grid-cols-5" : "lg:grid-cols-4"
                                    } gap-4 flex-1`}>
                                        ...
                                        <div className="w-full">
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setSearchData((s) => ({ ...s, originCity: val }));
                                                    fetchProvinces(val, 'origin');
                                                }}
                                            />
                                            {showOriginDropdown && (originSuggestions.length > 0 || loadingProvinces) && (
                                                <div className="absolute top-full left-0 right-0 mt-4 bg-white border border-slate-100 rounded-2xl shadow-2xl z-[100] max-h-60 overflow-y-auto custom-scrollbar overflow-x-hidden p-2">
                                                    {loadingProvinces && (
                                    ...
                                    <Field label="Điểm đến" icon={MapPin}>
                                        <div className="w-full">
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    const val = e.target.value;
                                                    setSearchData((s) => ({ ...s, destinationCity: val }));
                                                    fetchProvinces(val, 'destination');
                                                }}
                                            />
                                            {showDestDropdown && (destSuggestions.length > 0 || loadingProvinces) && (
                                                <div className="absolute top-full left-0 right-0 mt-4 bg-white border border-slate-100 rounded-2xl shadow-2xl z-[100] max-h-60 overflow-y-auto custom-scrollbar overflow-x-hidden p-2">
                                                    {loadingProvinces && (
                                                        <div className="p-4 flex items-center justify-center gap-2">
                                                            <Loader2 className="w-4 h-4 text-brand-primary animate-spin" />
            ...
            {/* ══════════════════  MAIN CONTENT  ══════════════════ */}
            <main className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-4 gap-12 text-left">
                ...
                <aside className="space-y-8">
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-slate-200">
                        ...
                        <h3 className="font-black text-xl mb-8 relative z-10 text-left">
                            Quy trình đặt vé
                        </h3>
                        <ol className="space-y-8 relative z-10 text-left">
                            {[
                    ...
                    {/* Guidelines */}
                    <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 text-left">
                    ...
                    {/* Promo Card */}
                    {!isLoggedIn ? (
                        <div className="bg-gradient-to-br from-brand-primary to-brand-accent rounded-[2.5rem] p-8 text-white shadow-xl shadow-brand-primary/20 text-left">
